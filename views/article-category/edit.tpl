                        ...
                        <form id="article-category-form" role="form" action="/admin/article-category/update/{{ .articleCategory.ID }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio radio-primary">
                                    <input type="radio" name="audit" id="audit1" value="1" {{if eq .articleCategory.Audit 1}}checked{{end}}>
                                    <label for="audit1">
                                        已审核
                                    </label>
                                </div>
                                <div class="radio radio-primary">
                                    <input type="radio" name="audit" id="audit2" value="0" {{if eq .articleCategory.Audit 0}}checked{{end}}>
                                    <label for="audit2">
                                        未审核
                                    </label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="keyword" placeholder="" class="form-control" value="{{ .articleCategory.Keyword }}">
                                </div>
                            </div>
