...
{{ define "content" }}
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <p><a class="btn btn-primary" href="friend-link-category/create"> <i class="fal fa-plus-circle"></i> 创建分类</a></p>
        <div class="row">
            <div class="col-lg-12">
            ...
            $('.dataTables').DataTable({
                ...
                columns: [
                    ...
                    { "data": null, "render": function(data, type, row, meta){
                        return '<a href="/admin/friend-link-category/show/'+row.base.id+'" class="btn btn-xs btn-outline btn-primary"><i class="fal fa-eye"></i> 查看</a> ' +
                            '<a href="/admin/friend-link-category/edit/'+row.base.id+'" class="btn btn-xs btn-outline btn-success"><i class="fal fa-edit"></i> 编辑</a> ' +
                            '<a href="/admin/friend-link-category/delete/'+row.base.id+'" class="btn btn-xs btn-outline btn-danger"><i class="fal fa-trash-alt"></i> 删除</a>';
                        }
                    }
                ],
