...
{{ define "content" }}
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-lg-6">
                <p>
                    <a class="btn btn-outline btn-success" href="/admin/comment/edit/{{ .comment.ID }}"><i class="fa fa-edit"></i> 更新</a>
                    <a class="btn btn-outline btn-danger" href="/admin/comment/delete/{{ .comment.ID }}"><i class="fa fa-trash"></i> 删除</a>
                </p>
