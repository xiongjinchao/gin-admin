            ...
            <div class="col-lg-6">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form id="friend-link-form" role="form" action="/admin/friend-link/update/{{ .friendLink.ID }}" method="post">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="title" placeholder="请输入友情链接名称" class="form-control" value="{{ .friendLink.Title }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="link" placeholder="请输入标签" class="form-control" value="{{ .friendLink.Link }}">
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="font-bold">图片</label>
                                <input id="file" type="file" name="file" accept="image/*"
                                       data-category="friend_link"
                                       data-initial-preview='{{.initialPreview}}'
                                       data-initial-preview-config='{{.initialPreviewConfig}}'>
                                <input id="image" type="hidden" name="image" value="{{ .friendLink.Image }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="sort" placeholder="" class="form-control" value="{{ .friendLink.Sort }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="start_at" placeholder="请输入开始时间" class="form-control" value="{{ .startAt }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="end_at" placeholder="请输入结束时间" class="form-control" value="{{ .endAt }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio radio-primary">
                                    <input type="radio" name="audit" id="audit1" value="1" {{if eq .friendLink.Audit 1}}checked{{end}}>
                                    <label for="audit1">
                                        已审核
                                    </label>
                                </div>
                                <div class="radio radio-primary">
                                    <input type="radio" name="audit" id="audit2" value="0" {{if eq .friendLink.Audit 0}}checked{{end}}>
                                    <label for="audit2">
                                        未审核
                                    </label>
                                </div>
