...
{{ define "content" }}
        ...
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">
                    <strong><i class="fal fa-bookmark"></i> {{ .title}}</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <p><a class="btn btn-primary" href="book-chapter/create"> <i class="fal fa-plus-circle"></i> 创建章节</a></p>
        <div class="row">
            <div class="col-lg-12">
            ...
            $('.dataTables').DataTable({
                ...
                columns: [
                    ...
                    { "data": null, "render": function(data, type, row, meta){
                        return '<a href="/admin/book-chapter/show/'+row.base.id+'" class="btn btn-xs btn-outline btn-primary"><i class="fal fa-eye"></i> 查看</a> ' +
                            '<a href="/admin/book-chapter/edit/'+row.base.id+'" class="btn btn-xs btn-outline btn-success"><i class="fal fa-edit"></i> 编辑</a> ' +
                            '<a href="/admin/book-chapter/delete/'+row.base.id+'" class="btn btn-xs btn-outline btn-danger"><i class="fal fa-trash-alt"></i> 删除</a>';
                        }
                    }
                ],
