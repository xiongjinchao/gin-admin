                            ...
                            <ul class="list-media">
                                <li class="list-item">
                                    <div class="client-item">
                                        <div class="media-img">
                                            <img src="/public/inspire/assets/img/avatar/user1.png" alt="">
                                        </div>
                                        <div class="info">
                                ...
                                <li class="list-item">
                                    <div class="client-item">
                                        <div class="media-img">
                                            <img src="/public/inspire/assets/img/avatar/user2.png" alt="">
                                        </div>
                                        <div class="info">
                                ...
                                <li class="list-item">
                                    <div class="client-item">
                                        <div class="media-img">
                                            <img src="/public/inspire/assets/img/avatar/user3.png" alt="">
                                        </div>
                                        <div class="info">
                                ...
                                <li class="list-item">
                                    <div class="client-item">
                                        <div class="media-img">
                                            <img src="/public/inspire/assets/img/avatar/user4.png" alt="">
                                        </div>
                                        <div class="info">
                            ...
                            <ul class="event-item">
                                <li>
                                    <a href="#">
                                        <div class="media">
                                            <div class="img-thumb">
                                                <img class="img-fluid" src="/public/inspire/assets/img/event/img-1.jpg" alt="">
                                            </div>
                                            <div class="text">
                                ...
                                <li>
                                    <a href="#">
                                        <div class="media">
                                            <div class="img-thumb">
                                                <img class="img-fluid" src="/public/inspire/assets/img/event/img-2.jpg" alt="">
                                            </div>
                                            <div class="text">
