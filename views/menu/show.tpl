...
{{ define "content" }}
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-lg-6">
                <p>
                    <a class="btn btn-outline btn-success" href="/admin/menu/edit/{{ .menu.ID }}"><i class="fal fa-edit"></i> 更新</a>
                    <a class="btn btn-outline btn-danger" href="/admin/menu/delete/{{ .menu.ID }}"><i class="fal fa-trash-alt"></i> 删除</a>
                </p>
